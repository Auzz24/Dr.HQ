...
function SignUp() {
  ...
  const [formState, setFormState] = useState({ name: '', email: '', phone: '', address: '', department: 'Emergency' });

  const [errorMessage, setErrorMessage] = useState('');

  const { name, email,  phone, address, department } = formState;
  ...
  const handleSubmit= async(e)=> {
    ...
    try {
      ...
      const response = await addDoctor({variables: {...formState}});
      ...
      <div id="container">
        ...
        <form onSubmit={handleSubmit} id="contact_form">
          ...
          <div class="message">
            ...
            <input type="text" placeholder="What is your Address?" name="address" id="address_input" defaultValue={address} onChange={handleChange} required></input>
          </div>
          {errorMessage && (
            <div>
          ...
          <div class="submit">
            <button type="submit" value="Send Message" id="new-post-form">Submit! </button>
          </div>
        </form>
      </div>
    </section>
